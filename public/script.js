...
const updateTextDivWidth = () => {
  if (window.innerWidth <= 480) {
    chatBoxTextdiv.style.width = '180px';
    chatBoxTextdiv.style.fontSize = '12px';
  } else {
    chatBoxTextdiv.style.width = '250px';
...
chatBoxTextdiv.style.padding = '20px';
chatBoxTextdiv.style.borderRadius = '20px';
chatBoxTextdiv.style.position = 'relative'; // Needed for absolute positioning of close button
...
// **X Button Styling (Without Background)**
...
chatBoxTextClose.style.color = '#333'; // Only text color remains
chatBoxTextClose.style.background = 'transparent'; // No background color
...
chatBoxTextClose.textContent = 'X';
